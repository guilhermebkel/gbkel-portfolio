...
const EXPECTED_PAGE_LOADING_DURATION = 5000

const Loading = () => (
	<Container animationDuration={EXPECTED_PAGE_LOADING_DURATION}>
		<AnimatedLogo animationDuration={EXPECTED_PAGE_LOADING_DURATION}>
